...
public class ClientController {
	...
	public ClientsInfoStatusCode getUniqueStack(@PathVariable("clientId") int clientId) {
		ClientsInfoStatusCode response= new ClientsInfoStatusCode();
		HashSet<String> stackData =  service.getStackUnique(clientId);
		if (response!=null) {
			response.setStatusCode(201);
			response.setMessage("success");
			response.setDescription("data successfully retrived..");
	...
	public ClientsInfoStatusCode getEmpExpYearsWise(@PathVariable("clientId") int clientId) {
		ClientsInfoStatusCode response= new ClientsInfoStatusCode();
	...
	public ClientsInfoStatusCode getEmpExpYearsWise() {
		ClientsInfoStatusCode response= new ClientsInfoStatusCode();
